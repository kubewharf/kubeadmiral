...
// Returns a lister for the given GVR if it exists. The lister for a FTC's source type will eventually exist as long as
// the FTC exists in the view of the FTCControllerBase.

...
func doCheck(t *testing.T, pref map[string]ClusterPreferences, replicas int64, clusters []string, expected map[string]int64) {
...
func doCheckWithExisting(t *testing.T, pref map[string]ClusterPreferences, replicas int64, clusters []string,
...
func doCheckWithExistingAndCapacity(t *testing.T, rebalance bool, pref map[string]ClusterPreferences, replicas int64, clusters []string,
...
func TestEqual(t *testing.T) {
	doCheck(t, map[string]ClusterPreferences{
		"*": {Weight: 1}},
		50, []string{"A", "B", "C"},
		// hash dependent
...
func TestEqualWithExisting(t *testing.T) {
	doCheckWithExisting(t, map[string]ClusterPreferences{
		"*": {Weight: 1}},
		50, []string{"A", "B", "C"},
...
func TestWithExistingAndCapacity(t *testing.T) {
	...
	doCheckWithExistingAndCapacity(t, true, map[string]ClusterPreferences{
		"*": {Weight: 1}},
		50, []string{"A", "B", "C"},
		map[string]int64{},
	...
	// desired A:20 B:20
	doCheckWithExistingAndCapacity(t, false, map[string]ClusterPreferences{
		"A": {Weight: 1},
		"B": {Weight: 1}},
		60, []string{"A", "B", "C"},
		map[string]int64{},

...
func TestListWatcherShouldHandleInitialList(t *testing.T) {
...
func TestListWatcherShouldHandleCreateUpdateAndDeleteEvents(t *testing.T) {
	_, client := setupFakeClient(100)
	listwatcher := pagedListWatcherFromClient(client, 10)
...
func TestListWatcherShouldRespectPageSize(t *testing.T) {
	...
	// ensure that we received the correct number of list notifications
	if counter != expectedNumReqs {
		t.Errorf("Expected %d list requests, got %d", expectedNumReqs, counter)
	}
}

func TestListWatcherShouldHandleRelistsCorrectly(t *testing.T) {
	_, client := setupFakeClient(100)
...
func TestListWatcherShouldHandleFailedListsCorrectly(t *testing.T) {
	_, client := setupFakeClient(100)

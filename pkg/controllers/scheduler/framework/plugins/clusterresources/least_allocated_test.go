...
func TestClusterResourcesLeastAllocated(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedList: []framework.ClusterScore{{Cluster: makeCluster("cluster1", 4000, 10000, 4000, 10000), Score: framework.MaxClusterScore},
		...
		},
		{
			...
			expectedList: []framework.ClusterScore{{Cluster: makeCluster("cluster1", 4000, 10000, 4000, 10000), Score: 37},

...
var clusterfederatedobjectsResource = v1alpha1.SchemeGroupVersion.WithResource("clusterfederatedobjects")

var clusterfederatedobjectsKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterFederatedObject")

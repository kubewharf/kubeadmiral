...
var federatedtypeconfigsResource = v1alpha1.SchemeGroupVersion.WithResource("federatedtypeconfigs")

var federatedtypeconfigsKind = v1alpha1.SchemeGroupVersion.WithKind("FederatedTypeConfig")

...
var schedulingprofilesResource = v1alpha1.SchemeGroupVersion.WithResource("schedulingprofiles")

var schedulingprofilesKind = v1alpha1.SchemeGroupVersion.WithKind("SchedulingProfile")

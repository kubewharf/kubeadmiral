...
var clustercollectedstatusesResource = v1alpha1.SchemeGroupVersion.WithResource("clustercollectedstatuses")

var clustercollectedstatusesKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterCollectedStatus")

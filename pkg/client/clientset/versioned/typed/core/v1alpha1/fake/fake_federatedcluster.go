...
var federatedclustersResource = v1alpha1.SchemeGroupVersion.WithResource("federatedclusters")

var federatedclustersKind = v1alpha1.SchemeGroupVersion.WithKind("FederatedCluster")

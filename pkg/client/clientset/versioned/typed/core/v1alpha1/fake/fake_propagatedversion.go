...
var propagatedversionsResource = v1alpha1.SchemeGroupVersion.WithResource("propagatedversions")

var propagatedversionsKind = v1alpha1.SchemeGroupVersion.WithKind("PropagatedVersion")

...
import (
	v1alpha1 "github.com/kubewharf/kubeadmiral/pkg/apis/types/v1alpha1"
...
// TypesV1alpha1Client is used to interact with features provided by the types.kubeadmiral.io group.

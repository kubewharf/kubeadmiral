...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.Aggregation":               schema_pkg_apis_hpaaggregator_v1alpha1_Aggregation(ref),
		"github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptor":     schema_pkg_apis_hpaaggregator_v1alpha1_ExternalMetricAdaptor(ref),
		"github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptorList": schema_pkg_apis_hpaaggregator_v1alpha1_ExternalMetricAdaptorList(ref),
		"github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptorSpec": schema_pkg_apis_hpaaggregator_v1alpha1_ExternalMetricAdaptorSpec(ref),
...
func schema_pkg_apis_hpaaggregator_v1alpha1_Aggregation(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Aggregation define a flag for hpa aggregator that do not have actual resources.",
				Type:        []string{"object"},
...
func schema_pkg_apis_hpaaggregator_v1alpha1_ExternalMetricAdaptor(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExternalMetricAdaptor describes how to adapt external metrics for each member clusters.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptorSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptorSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_hpaaggregator_v1alpha1_ExternalMetricAdaptorList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExternalMetricAdaptorList is a list of ExternalMetricAdaptor objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptor"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubewharf/kubeadmiral/pkg/apis/hpaaggregator/v1alpha1.ExternalMetricAdaptor", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_hpaaggregator_v1alpha1_ExternalMetricAdaptorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"metric": {
						SchemaProps: spec.SchemaProps{
							Description: "Metric determines the external metric in hpa",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},

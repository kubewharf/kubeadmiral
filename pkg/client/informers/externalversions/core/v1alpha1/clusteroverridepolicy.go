	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha1().ClusterOverridePolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha1().ClusterOverridePolicies().Watch(context.TODO(), options)
			},
		},
		&corev1alpha1.ClusterOverridePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterOverridePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha1.ClusterOverridePolicy{}, f.defaultInformer)
}

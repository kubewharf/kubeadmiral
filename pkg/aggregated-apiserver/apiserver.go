...
import (
	...
	aggregatedinstall "github.com/kubewharf/kubeadmiral/pkg/apis/aggregatedapiserver/install"
	"github.com/kubewharf/kubeadmiral/pkg/apis/aggregatedapiserver/v1alpha1"
	fedclient "github.com/kubewharf/kubeadmiral/pkg/client/clientset/versioned"
	fedinformers "github.com/kubewharf/kubeadmiral/pkg/client/informers/externalversions"
	storage "github.com/kubewharf/kubeadmiral/pkg/registry/aggregated-apiserver/aggregation"
...
func init() {
	aggregatedinstall.Install(Scheme)

	// we need custom conversion functions to list resources with options
	utilruntime.Must(v1alpha1.RegisterConversions(Scheme))
...
// Server contains state for a Kubernetes aggregation master/api server.
type Server struct {
